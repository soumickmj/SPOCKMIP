...
class UNetDeepSuplevel4(nn.Module):
    """
    UNet - Basic Implementation
    Input _ [batch * channel(# of channels of each image) * depth(# of frames) * height * width].
    Paper : https://arxiv.org/abs/1505.04597
    ...
    def __init__(self, in_ch=1, out_ch=1):
        super(UNetDeepSuplevel4, self).__init__()
        ...
        self.Conv_d3 = ConvBlock(filters[1], 1)
        self.Conv_d4 = ConvBlock(filters[2], 1)
        self.Conv_d5 = ConvBlock(filters[3], 1)
...
class UNetDeepSuplevel4WTA(nn.Module):
    """
    UNet - Basic Implementation
    Input _ [batch * channel(# of channels of each image) * depth(# of frames) * height * width].
    Paper : https://arxiv.org/abs/1505.04597
    ...
    def __init__(self, in_ch=1, out_ch=1):
        super(UNetDeepSuplevel4WTA, self).__init__()
        ...
        self.Conv1 = ConvBlockV2(in_ch, filters[0])
        self.Conv2 = ConvBlockV2(filters[0], filters[1])
        self.Conv3 = ConvBlockV2(filters[1], filters[2])
        self.Conv4 = ConvBlockV2(filters[2], filters[3])
        self.Conv5 = ConvBlockV2(filters[3], filters[4])

        # 1x1x1 Convolution for Deep Supervision
        self.Conv_d3 = ConvBlockV2(filters[1], 1)
        self.Conv_d4 = ConvBlockV2(filters[2], 1)
        self.Conv_d5 = ConvBlockV2(filters[3], 1)
